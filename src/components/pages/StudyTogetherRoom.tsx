          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-5xl font-bold">
                <span className="text-gradient-primary">Study Together</span>
              </h1>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {participants.map((participant, index) => (
                    <motion.div
                      ...
                      className={`p-3 rounded-lg border transition-all ${participant.is_online
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          ...
                          <div className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 border-white dark:border-gray-900 ${participant.is_online ? 'bg-green-500' : 'bg-gray-400'
                            }`} />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="text-sm font-medium flex items-center gap-1 truncate">
                            ...
                            {participant.user_id === room?.host_user_id && <Crown className="w-3 h-3 text-yellow-500 flex-shrink-0" />}
                          </h3>
                          <div className="flex items-center gap-2 mt-1">
                  ...
                  <div className="h-64 overflow-y-auto space-y-3 bg-muted/20 rounded-lg p-3">
                    {chatMessages.map((message) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className={`text-sm ${message.message_type === 'system'
